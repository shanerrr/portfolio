...
export default function Navbar() {
  return (
    <div className="px-6 md:px-10 lg:px-12 h-24 fixed w-full flex items-center">
      <div className="flex justify-between w-full">
        ...
        <Link
          className="bg-black px-4 py-2 rounded bg-transparent border border-yellow text-sm"
          href="/resume.pdf"
        >
          Resume
        </Link>
